...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    ...
    # fields 
    numericInput('cat1',
                 '% of Total for 1st Category',
                 min = 0,
                 max = 100,
                 step = 1),
    
    numericInput('cat2',
                 '% of Total for 2nd Category',
                 min = 0,
                 max = 100,
                 step = 1
                 ),
